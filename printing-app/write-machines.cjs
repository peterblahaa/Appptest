...
fs.writeFileSync('api/machines.php', machinesPhp);
fs.writeFileSync('machines-for-ftp.php', machinesPhp);
console.log('machines.php created successfully!');
